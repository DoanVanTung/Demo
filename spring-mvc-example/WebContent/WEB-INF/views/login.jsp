...
<body
	style="background-image: url('http://www.mamnonhoamattroi.com/css/img/04.gif')">
	<div style="background-color: powderblue;">
		...
		<ul class="nav justify-content-end">
			...
			<li class="nav-item">      <a class="nav-link" href="#"
				style="margin-left: 600px;">Trang Chủ</a>    
			</li>    
			<li class="nav-item">      <a class="nav-link" href="#">Hỏi
					Đáp</a>    
			</li>    
			<li class="nav-item">      <a class="nav-link" href="#">Trợ
					Giúp</a>    
			</li>
		</ul>
	 </header>
	...
	<!------ Include the above in your HEAD tag ----------> <!DOCTYPE html>
	<html>
<head>
		...
		<form class="form-horizontal" action="login" method="get">
			<div class="d-flex justify-content-center h-100">
				<div class="card">
					...
					<div class="card-body" style="background-color: clear">
